...
using PrimeiraAPI.Repository.Impl;
using System;
...
namespace PrimeiraAPI
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<PrimeiraAPIContext>(option => option.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
